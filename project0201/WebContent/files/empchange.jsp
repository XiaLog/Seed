...
<body class="ContentBody">
  <form action="afterchange.do" method="post" name="form">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>员工信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><input name="empno" type="text" class="text" value="${emp.empno }" style="width:154px" />
				        <span class="red">*</span></td>
					    <td width="16%" align="right" nowrap="nowrap">密码:</td>
					    <td width="34%"><input type="password" name="password" value="${emp.password }" style="width:154px" ></td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td><select name="sex" >
                            <option selected="selected" value="${emp.sex }">==请选择==</option>
					  ...
					  <tr>
					    ...
					    <td><select name="emptype" >
                            <option  selected="selected" value="${emp.emptype }">==请选择==</option>
